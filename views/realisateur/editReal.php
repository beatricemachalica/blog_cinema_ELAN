...
<div class="content">
  <form action="./index.php?action=modifierRealisateur&id='<?= $director['id_realisateur']; ?>'" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="nom_realisateur" name="nom_realisateur" value="<?= $director['nom']; ?>" required>
    </div>
    <div class="form-group">
      <label for="prenom réalisateur">Prénom du réalisateur</label>
      <input type="text" class="form-control" id="prenom_realisateur" name="prenom_realisateur" value="<?= $director['prenom']; ?>" required>
    </div>
    <div class="form-group">
      <label for="sexe réalisateur">Sexe</label>
      <input type="text" class="form-control" id="sexe" name="sexe" value="<?= $director['sexe']; ?>">
    </div>
    <div class="form-group">
      <label for="dateNaissance réalisateur">Date de naissance</label>
      <input type="text" class="form-control" id="dateNaissance" name="dateNaissance" value="<?= $director['dateNaissance']; ?>">
